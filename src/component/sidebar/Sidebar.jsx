        ...
        <>
            <div className='flex'>
                <div className={`bg-black h-screen p-5 pt-8 ${open ? "w-72" : "w-20"} duration-300 relative`}>
                    <BsArrowLeftShort className={`bg-black text-black !text-black text-3xl rounded-full absolute -right-3 top-9 border border-white cursor-pointer ${(!open && "rotate-180")}`} onClick={() => setOpenSidebar(!open)} />
